...
export function Testimonials() {
  return (
    <>
     <div className="max-w-5xl mt-48 mx-auto text-center">
    ...
    <div className="h-[22rem] rounded-md    flex flex-col antialiased bg-white dark:bg-neutral-950 dark:bg-grid-white/[0.05] items-center justify-center relative overflow-hidden">
      <InfiniteMovingCards
        items={testimonials}
        direction="right"
        speed="slow"
